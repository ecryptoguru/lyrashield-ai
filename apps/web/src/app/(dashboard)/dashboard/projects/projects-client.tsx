        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((project) => (
            <Link
              ...
              className="group bg-card block rounded-xl border p-5 shadow-sm transition-[border-color,box-shadow,transform] duration-(--duration-base) ease-out hover:-translate-y-0.5 hover:shadow-md"
            >
