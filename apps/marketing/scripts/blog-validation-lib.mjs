...
export const CTA_LINK_REQUIREMENTS = Object.freeze({
  ...
  "Pillar + full app scan CTA": FREE_CHECKLIST_ROUTE,
  "Pillar + product audit trail": FREE_CHECKLIST_ROUTE,
  "Pillar + schedules/notifications": FREE_CHECKLIST_ROUTE,
  "Pillar + product SCA": FREE_CHECKLIST_ROUTE,
  "Pillar + MCP security": FREE_CHECKLIST_ROUTE,
  "Pillar + product MCP": FREE_CHECKLIST_ROUTE,
  "Pillar + product approval model": FREE_CHECKLIST_ROUTE,
  "Pillar + approvals/audit": FREE_CHECKLIST_ROUTE,
  "Pillar + verified findings": FREE_CHECKLIST_ROUTE,
  "Pillar + GitHub diff gate": FREE_CHECKLIST_ROUTE,
  "Pillar + retest workflow": FREE_CHECKLIST_ROUTE,
  "Pillar + product retest": FREE_CHECKLIST_ROUTE,
  "Pillar + product SARIF": FREE_CHECKLIST_ROUTE,
  "Pillar + launch readiness": FREE_CHECKLIST_ROUTE,
  "Pillar + product reports": FREE_CHECKLIST_ROUTE,
  "Pillar + fix/retest": FREE_CHECKLIST_ROUTE,
  "Pillar + LyraShield Score methodology": FREE_CHECKLIST_ROUTE,
  "Pillar + findings workflow": FREE_CHECKLIST_ROUTE,
  "Pillar + scorecards/reports": FREE_CHECKLIST_ROUTE,
})
...
export const PROHIBITED_CLAIMS = [
  ...
  ["nonexistent Fix PR tool", /\bcreate_fix_pr_draft\b/i],
  ["verification-only finding filter", /\b(?:return|surface|list)\s+only\s+verified\s+findings\b/i],
  ["unqualified verified issue", /(?<!independently )\bverified\s+issues?\b/i],
  ["unqualified verified security results", /\bverified\s+security\s+results?\b/i],
  ["unqualified verified checks", /\bverified\s+checks?\b/i],
  ["flattened evidence-state loop", /\bTarget\s+to\s+Scan\s+to\s+Verified\s+Finding\s+to\s+Fix\b/i],
