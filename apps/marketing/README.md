...
- Set `PUBLIC_SCANNER_URL` in `.env` to the public scanner origin. Set `PUBLIC_APP_URL` separately only when the authenticated dashboard is ready. The build strips trailing slashes from both.
