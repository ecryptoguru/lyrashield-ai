...
The browser-local [AI app security checklist](/tools/ai-app-security-checklist) can help document whether the team has an owner, review step, and release gate for dependency scripts. It does not read the lockfile, inspect package artifacts, or prove that an allowed script is safe.
