...
This authenticated score layer is separate from the public Lite Check. The passive [LyraShield Lite Check](/scan) does not produce the official LyraShield Score and is not a penetration test, certification, warranty, or guarantee. Full repository review is available in the open beta; results remain scope- and evidence-bounded.
