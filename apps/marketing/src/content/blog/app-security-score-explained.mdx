...
[OWASP ASVS 5.0.0](https://owasp.org/projects/asvs) provides versioned application-security requirements and verification levels. A level describes a selected verification target and rigor. It is not a letter grade for product safety.
