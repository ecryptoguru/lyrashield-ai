...
faq:
  ...
  - q: "Can Base44 permissions protect individual fields?"
    a: "Current Base44 documentation says entity permissions operate at the table level and do not provide field-level permissions. Separate sensitive fields into a restricted entity or return them through an authorized backend function."
...
## The risky pattern: a public app with broad table reads
...
## Enforce table permissions, then split confidential fields
...
Current Base44 documentation states that permissions apply at the table level, not per field. If a user may read a ticket row, do not assume one property inside that row remains hidden because the component does not render it.
...
## Verify with three runtime identities
