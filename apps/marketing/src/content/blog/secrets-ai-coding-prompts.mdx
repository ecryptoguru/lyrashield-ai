...
description: "Keep live credentials out of AI tools, and use customer or regulated data only through an approved, minimized workflow with verified controls."
pubDate: 2026-07-17
...
faq:
  ...
  - q: "Can I share customer logs after removing names?"
    a: "Only through a formally approved workflow after minimization removes unnecessary identifiers and payloads. The exact product, workspace, provider, contract, retention, access, and audit controls must permit that data class. Live credentials and tokens still stay out."
