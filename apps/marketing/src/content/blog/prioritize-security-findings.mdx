...
[FIRST's EPSS documentation](https://www.first.org/epss/) describes a probability estimate that a published CVE will be exploited in the wild in the next 30 days. EPSS is not a business-impact score, a guarantee, or a measure for findings without a relevant CVE.
