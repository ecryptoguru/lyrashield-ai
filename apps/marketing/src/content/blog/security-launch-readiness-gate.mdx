...
The [LyraShield AI methodology](/methodology) explains the evidence states and limitations behind a decision. It also explains why incomplete evidence remains inconclusive.
...
- [OWASP Web Security Testing Guide v4.2](https://owasp.github.io/www-project-web-security-testing-guide/v42/)
