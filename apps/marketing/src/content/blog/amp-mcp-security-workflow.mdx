---
title: Amp MCP security workflow for agent scans
...
Wrap up by running [AI app security checklist](/tools/ai-app-security-checklist) on the candidate build and confirming your config matches [Amp integration guide](/docs/integrations/amp). When ready to evaluate managed verification, [create an account at LyraShield AI](https://app.lyrashieldai.com/sign-up) and keep the PR gate as your source of truth.
