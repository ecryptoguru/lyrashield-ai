...
| -------------------- | ----------------- | ----------------- | --------------------- |
| `member.suspend`     | workspace owner   | same workspace    | REST, support console |
...
- [OWASP WSTG: API Broken Function Level Authorization](https://owasp.github.io/www-project-web-security-testing-guide/latest/4-Web_Application_Security_Testing/12-API_Testing/04-API_Broken_Function_Level_Authorization)
