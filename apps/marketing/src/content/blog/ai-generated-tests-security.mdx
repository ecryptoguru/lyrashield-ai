...
Use [OWASP ASVS](https://owasp.org/projects/asvs) or another reviewed requirement set to derive invariants outside the generated patch. Select requirements that match the application architecture. ASVS is a verification framework, not proof that every listed control applies or passes.
