...
[OWASP ASVS 5.0.0](https://owasp.org/projects/asvs) can provide scoped requirements for API authentication, access control, input handling, files, cryptography, logging, and configuration. It does not certify an endpoint unless the selected requirements are actually verified.
