...
The public [LyraShield Lite Check](/scan) is passive and read-only for an authorized public surface. It is not the full repository review, client acceptance decision, or security guarantee. Full repository review is available in the open beta; results remain scope- and evidence-bounded.
