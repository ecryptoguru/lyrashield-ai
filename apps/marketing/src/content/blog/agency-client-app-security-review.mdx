...
[NIST SP 800-218](https://csrc.nist.gov/pubs/sp/800/218/final) provides a common secure-development vocabulary that producers, acquirers, and suppliers can use to set expectations. [OWASP ASVS 5.0.0](https://owasp.org/projects/asvs) can help define technical requirements and verification scope. Neither source turns an agency review into a guarantee.
