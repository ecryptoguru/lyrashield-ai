...
Use [OWASP ASVS 5.0.0](https://owasp.org/projects/asvs) as a source of technical verification requirements, then select scope according to the application's risk. An ASVS checklist is not a certificate that the application is secure. It is a structured way to avoid inventing requirements from memory.
