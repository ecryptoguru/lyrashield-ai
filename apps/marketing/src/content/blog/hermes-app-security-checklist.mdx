...
faq:
  ...
  - q: 'How do I add LyraShield to Hermes?'
    a: 'Add mcp_servers.lyrashield with command npx -y @lyrashield/mcp@0.2.5 for stdio or url https://app.lyrashieldai.com/api/mcp with Bearer header for remote.'
...
Integration is deliberately small: stdio via `npx -y @lyrashield/mcp@0.2.5` and remote Streamable HTTP at `https://app.lyrashieldai.com/api/mcp` with `lsk_` Bearer per [integrations hub](/docs/integrations). The target-to-report loop is available in the open beta and remains evidence-bounded for teams shipping AI-built code via Hermes alongside [pi-coding-agent-app-security-checklist](/blog/pi-coding-agent-app-security-checklist) and [openclaw-app-security-checklist](/blog/openclaw-app-security-checklist).
