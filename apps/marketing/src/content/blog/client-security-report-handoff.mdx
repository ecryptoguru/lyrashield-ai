...
Repository report code freezes creation-time snapshots and includes findings, retest summary, methodology, and limitations. Describe that implemented behavior without presenting a synthetic example as a customer result, production assessment, benchmark, or complete engagement.
...
- [OWASP Web Security Testing Guide v4.2: Reporting](https://owasp.github.io/www-project-web-security-testing-guide/v42/5-Reporting/README)
- [OWASP Web Security Testing Guide v4.2: Introduction](https://owasp.github.io/www-project-web-security-testing-guide/v42/2-Introduction/README)
...
- [OWASP Autonomous Penetration Testing Standard: Reporting](https://owasp.github.io/APTS/standard/8_Reporting/)
