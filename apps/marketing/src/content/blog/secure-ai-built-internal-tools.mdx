...
[OWASP ASVS 5.0.0](https://owasp.org/projects/asvs) can help define technical requirements for authentication, access control, validation, sessions, logging and configuration. Select requirements by risk and record the actual coverage. Do not describe an informal checklist as ASVS verification.
