...
faq:
  - q: "Does decoding a JWT verify it?"
    a: "No. Base64URL decoding only reveals the header and claims. Acceptance requires cryptographic verification plus issuer, audience, time, token-type, and application-session checks."
