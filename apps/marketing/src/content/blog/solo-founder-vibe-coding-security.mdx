...
[OWASP ASVS 5.0.0](https://owasp.org/projects/asvs) can supply technical requirements when the app needs a deeper review. Select requirements according to the product's risk and record what was actually verified. Do not claim ASVS coverage from a general checklist.
