...
Use a repository built for testing. Place a clearly synthetic marker in a file that should be excluded, then confirm each approved assistant surface does not use it. Repeat the test for inline completion, chat, review, and any agent mode because control coverage may differ.
