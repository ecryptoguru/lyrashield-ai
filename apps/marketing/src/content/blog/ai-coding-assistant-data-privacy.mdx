...
Anthropic's [consumer training documentation](https://privacy.claude.com/en/articles/10023580-is-my-data-used-for-model-training) distinguishes consumer products from commercial products. It describes consumer opt-in, safety-review, feedback, and incognito behavior. Anthropic separately states in its [commercial training guidance](https://privacy.claude.com/en/articles/7996868-is-my-data-used-for-model-training) that commercial product data is not used for training unless the customer joins an explicit program. Your organization's agreement and settings still control the actual authorized use.
