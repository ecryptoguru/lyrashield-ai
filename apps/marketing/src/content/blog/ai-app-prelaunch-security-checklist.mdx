...
LyraShield AI publicly documents the Vibe Security 50 as 43 code/URL review controls and 7 evidence-required controls. That split does not mean one run finds or fixes the entire set. Evidence-required items need accountable human or operational proof.

The [evidence methodology](/methodology) shows how target, coverage, evidence state, retest, and limitations remain distinct. No report proves complete coverage or eliminates the need to review retained limitations.
