---
title: "Protect AGENTS.md and Rules Files From Poisoning"
description: "Prevent prompt injection in AGENTS.md and coding-tool rules with provenance, code ownership, protected review, scoped rules, and conflict tests."
pubDate: 2026-07-17
