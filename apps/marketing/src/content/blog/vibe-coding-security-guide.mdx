...
The [OWASP Top 10:2025](https://owasp.org/Top10/) is a useful awareness document, not a complete test plan. [OWASP ASVS 5.0.0](https://owasp.org/projects/asvs) provides testable web application requirements. [NIST's Secure Software Development Framework](https://csrc.nist.gov/pubs/sp/800/218/final) organizes secure development practices that teams can add to an existing life cycle. Use such references to choose and justify tests, then record what actually ran.
