...
The [OWASP Secure Headers Project](https://owasp.github.io/www-project-secure-headers/) documents headers and deprecated patterns. Use it as a policy reference, then adapt each value to the application's behavior.
...
- [OWASP Secure Headers Project](https://owasp.github.io/www-project-secure-headers/)
