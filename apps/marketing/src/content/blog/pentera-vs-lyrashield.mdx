...
If you want a structured release assurance loop for your next AI built app, run the free [AI app security checklist](/tools/ai-app-security-checklist) and then [register at lyrashieldai.com](https://app.lyrashieldai.com/sign-up) to try the full loop.
