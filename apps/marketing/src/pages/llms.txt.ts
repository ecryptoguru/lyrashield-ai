...
export const GET: APIRoute = async (context) => {
  ...
  const sections = [
    ...
    "Pricing: Trial includes 60 one-time agent-minutes. Starter is $29/month, Pro is $99/month, Launch Assurance is $499/month, and Enterprise starts at $1,500/month. Regional INR pricing and annual options are published on /pricing.",
