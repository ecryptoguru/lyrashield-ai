...
export const PERMISSIONS = {
  ...
  scanAttachment: {
    read: "scan_attachment:read",
    upload: "scan_attachment:upload",
    delete: "scan_attachment:delete",
  },
  finding: {
    view: "finding:view",
  ...
  affiliate: {
    ...
    // Global affiliate administration (approve/reject/suspend, tier overrides,
    // payout approval) is platform-operator authority — see User.platformRole.
    // No tenant role grants it.
  },
} as const
...
const ROLE_PERMISSIONS: Record<MemberRole, Permission[]> = {
  ...
  // ADMIN gets workspace governance permissions in the list below
  ADMIN: [
    ...
    PERMISSIONS.scanAttachment.read,
    PERMISSIONS.scanAttachment.upload,
    PERMISSIONS.scanAttachment.delete,
...
export const OPERATIONAL_PERMISSIONS: readonly Permission[] = [
  ...
  ...Object.values(PERMISSIONS.scanAttachment),
