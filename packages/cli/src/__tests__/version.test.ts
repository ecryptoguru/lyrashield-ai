...
describe("CLI version", () => {
  it("uses one publishable 0.2.8 version across runtime and package metadata", async () => {
    ...
    expect(Object.values(packageJson.dependencies)).not.toContainEqual(expect.stringMatching(/^workspace:/))
