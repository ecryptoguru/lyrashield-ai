...
describe("CLI version", () => {
  it("uses one publishable 0.2.13 version across runtime and package metadata", async () => {
    ...
    expect(CLI_VERSION).toBe("0.2.13")
    ...
    expect(packageJson.dependencies["@lyrashield/agent-plugin"]).toBe("workspace:^")
