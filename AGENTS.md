...
- Current `main` passes **841 tests in 90 files** and **2 Chromium E2E tests**, plus lint, typecheck, production build, formatting, Prisma client generation, migration drift/application across **20 migrations**, SCA/secret scanning, and `git diff --check`.
