...
- Release run `32916256313` deployed product `7abd9baa8943c8e25f954ad6e6d9bd2a6c84d6b7`: app `lyrashield-app--0000193`, scanner `lyrashield-scanner--0000174`, and egress proxy `lyrashield-egress-proxy--0000043` are healthy at 100% traffic. Worker digest `sha256:fd1888ccaedc9d9f2618398c1924571f23a03fed05efb6b772c922cf43d7cf01` runs that product with engine `852b1ed7ff76d177cef4db5aa1cfbd3bbe6d2664`; post-scan Docker health and `/api/ready/scans` passed with zero restarts.
...
8. Triage the 25 findings retained by current Standard scan `cmt9el7p7000001hdjnjo90wk` and obtain independent verification where warranted. Keep all unverified results `DETECTED` or `INCONCLUSIVE`.
