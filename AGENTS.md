...
- Current `main` passes **818 tests in 85 files** and **2 Chromium E2E tests**, plus lint, typecheck, production build, formatting, Prisma client generation, and `git diff --check`.
