...
- Current `main` passes **869 core tests in 94 files**, **79 marketing tests in 12 files**, **16 motion tests**, and **2 Chromium E2E tests**, plus lint, typecheck, production build, formatting, Prisma client generation, migration drift/application across **21 migrations**, SCA/secret scanning, and `git diff --check`.
