...
- Current `main` passes **822 tests in 86 files** and **2 Chromium E2E tests**, plus lint, typecheck, production build, formatting, Prisma client generation, and `git diff --check`.
