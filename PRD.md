...
- Merged PR #115 baseline plus UX V2 Phases 0–10 and follow-up: lint, typecheck, production build, formatting, Prisma client generation, migration drift/application, SCA/secret scanning, security diff gate, CodeRabbit, `git diff --check`, **1030 core tests in 116 files**, **80 marketing tests in 12 files**, **16 motion tests**, and **4 passing Playwright Chromium tests**. Historical checkpoint counts below remain dated evidence, not the current release gate.
