...
> **Status date:** 2026-07-25. This section is the authoritative product/engineering snapshot. Update it whenever implementation coverage or a release gate changes materially.
...
| Model routing and accounting | Complete in app code | Safe/Quick/Standard route to Luna/medium; Deep/Custom use Terra/medium coordination with Luna/medium specialists; protected limits reach the engine; actual-model per-request standard/long-context buckets drive private reconciliation; the dashboard exposes no costs. Engine context compaction and GPT-5.6 execution hardening are merged; controlled production proof remains. |
