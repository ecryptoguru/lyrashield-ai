...
- Current `main` baseline (through PR #71): lint, typecheck, production build, formatting, Prisma client generation, `git diff --check`, **818 passing tests in 85 files**, and **2 passing Playwright Chromium tests**. Historical checkpoint counts below remain dated evidence, not the current release gate.
