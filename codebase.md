...
>
> **Current baseline — 2026-07-15:** 4 apps, 10 shared packages (including `packages/score`), 22 web page files, 40 API route files, 39 Prisma models, 18 enums, 18 migrations, and 20 directly RLS-protected workspace tables. `main` passes lint, typecheck, test, E2E, production build, formatting, Prisma client generation, and diff checks (778 tests in 77 files; 2 Playwright Chromium tests). Sections 17–41 are dated implementation history; their older counts are checkpoints, not the current gate.
