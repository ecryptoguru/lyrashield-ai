...
- **Cloud** — two product lines. _Scan_ (find what's wrong): free 7-day trial, Starter, Pro. _Launch Assurance_ (prove it to a third party): Agency tier, contact-led Enterprise. Metered in agent-minutes; failed scans are never billed.
