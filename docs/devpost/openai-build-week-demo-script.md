...
2. **0:18–0:48 — working public product**
...
5. **1:48–2:22 — Codex and GPT-5.6**

   Show this repository's `README.md`, a recent green GitHub Actions run, and a safe excerpt of the worker model-routing code or production-readiness plan.

   > Codex accelerated implementation, testing, CI remediation, deployment verification, and this evidence-safe release workflow. In the controlled full-scan contract, GPT-5.6 Luna handles Safe, Quick, and Standard work at medium reasoning. Terra coordinates Deep or Custom work with Luna specialists. Before requests run, the system bounds context, agents, output, and spend.
