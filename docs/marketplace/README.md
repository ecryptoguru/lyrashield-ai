...
- Codebuff: the [LyraShield AI publisher](https://codebuff.com/publishers/lyrashield) has a public but unverified `0.1.0` listing; `0.1.1` republishes the MCP declaration and is pending publication.
